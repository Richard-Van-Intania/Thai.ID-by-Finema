            ...
            CenterAlignedTopAppBar(
                title = {
                    ...
                    IconButton(
                        ...
                        Icon(
                            imageVector = Icons.Rounded.BorderColor, contentDescription = null, tint = primaryBlack
                        )
                    }
                }, colors = TopAppBarDefaults.centerAlignedTopAppBarColors(
                    containerColor = white, navigationIconContentColor = primaryBlack, actionIconContentColor = primaryBlack
                )
            )
        ...
        if (locale==null) Box(
            ...
            item {
                ...
                Row(
                    ...
                    Text(
                        text = if (birthDate.isEmpty()) stringResource(R.string.date_format)
                        else when (locale) {
                            EN -> {

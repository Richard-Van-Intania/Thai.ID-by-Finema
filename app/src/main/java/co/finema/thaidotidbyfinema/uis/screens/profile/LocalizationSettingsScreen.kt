             ...
             TextButton(
              onClick = {
                 ...
                 Row(modifier = Modifier.fillMaxWidth().padding(vertical = 16.dp), verticalAlignment = Alignment.CenterVertically) {
                     ...
                     Image(painter = painterResource(id = if (locale == EN) R.drawable.lang_check else R.drawable.lang_uncheck), contentDescription = null, modifier = Modifier.height(24.dp))
                 }
             }
             ...
             TextButton(
              onClick = {
                 ...
                 Row(modifier = Modifier.fillMaxWidth().padding(vertical = 16.dp), verticalAlignment = Alignment.CenterVertically) {
                     ...
                     Spacer(modifier = Modifier.weight(1f))
                     Image(painter = painterResource(id = if (locale == TH) R.drawable.lang_check else R.drawable.lang_uncheck), contentDescription = null, modifier = Modifier.height(24.dp))
                 }
             }
             HorizontalDivider(thickness = 1.dp, color = neutral02)
         }
